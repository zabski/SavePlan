...
import com.zmobile.util.IabHelper;
import com.zmobile.util.IabResult;
import com.zmobile.util.Inventory;
import com.zmobile.util.Purchase;
 ...
 */
public class HandlerPurchase {

    private static HandlerPurchase instance = null;
    Activity ctx;
    Updatable act;
    ...
    // Does the user have bought remove ads item?
    boolean mHasRemovedAds = false;

    // SKUs for our products: the premium upgrade (non-consumable) and gas (consumable)
    static final String SKU_PREMIUM = "premium";
    static final String SKU_GAS = "gas";
    static final String SKU_ADS = "saveplan_remove_ads";

    // SKU for our subscription (infinite gas)
    static final String SKU_INFINITE_GAS = "infin_gas";
    ...
    public static HandlerPurchase getInstance(Activity ctx){
        if (instance == null)
            instance = new HandlerPurchase(ctx);
        instance.ctx = ctx;
        instance.act = (Updatable)ctx;
        return instance;
    }


    private HandlerPurchase(Activity ctx) {
        this.ctx = ctx;
        this.act = (Updatable)ctx;
         ...
         */
        String base64EncodedPublicKey = "";
        //String base64EncodedPublicKey =   "";
        ...
        if (ctx.getPackageName().startsWith("com.example")) {
    ...
    IabHelper.QueryInventoryFinishedListener mGotInventoryListener = new IabHelper.QueryInventoryFinishedListener() {
        public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
            ...
            Purchase adsRemoved = inventory.getPurchase(SKU_ADS);
            if (adsRemoved!=null){
                act.setAdsVisible(false);
                mHasRemovedAds = true;
            }
    ...
    public void onBuyGasButtonClicked(View arg0) {
        ...
        mHelper.launchPurchaseFlow(ctx, SKU_GAS, RC_REQUEST,
                mPurchaseFinishedListener, payload);
    }

    // User clicked the "Buy Gas" button
    public void onRemoveAdsButtonClicked(View arg0) {
        Log.d(TAG, "Buy gas button clicked.");

        if (mHasRemovedAds) {
            complain("No need! You have removed ads. Isn't that awesome?");
            return;
        }
        ...
        if (mHelper!=null) {
            ...
            mHelper.launchPurchaseFlow(ctx, SKU_ADS, RC_REQUEST,
                    mPurchaseFinishedListener, payload);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (!mHelper.handleActivityResult(requestCode, resultCode, data)) {
            ...
            //(Activity.class)
            //super.
            //Class cl = ((ctx.getClass()).getSuperclass());
    ...
    void saveData() {
        ...
        SharedPreferences.Editor spe = ctx.getPreferences(ctx.MODE_PRIVATE).edit();
    ...
    void loadData() {
        SharedPreferences sp = ctx.getPreferences(ctx.MODE_PRIVATE);
