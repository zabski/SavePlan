...
public class FacebookNativeAds implements AdListener {
    ...
    */
    ...
    protected void createAndLoadNativeAd(Context ctx, LinearLayout nativeAdContainer, int templateId, String fbNativeId) {
        ...
        TestDevices.add("0123456789ABCDEF");
        TestDevices.add("YT9005GDD5");
        TestDevices.add("YT910WM2SK");
		...
		*/
        ...
        if (templateId == R.layout.ad_unit_no_img || templateId == R.layout.ad_unit_row_no_img){
            TextView link = (TextView) nativeAdContainer.findViewById(R.id.native_ad_social_context);
            link.setVisibility(View.GONE);
            Button button = (Button) nativeAdContainer.findViewById(R.id.native_ad_call_to_action);
    ...
    public void onError(Ad ad, AdError error) {
        ...
        if (log>3) Toast.makeText(context, "Fb Ad Error: "+error.getErrorMessage(), Toast.LENGTH_LONG).show();
        loadError = true;
    ...
    public void onAdClicked(Ad ad) {
        if (log>1) Toast.makeText(context, "Fb: Ad Clicked", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onAdLoaded(Ad ad) {
        ...
        if (log>1) Toast.makeText(context, "Fb: Native loadded ", Toast.LENGTH_SHORT).show();
        // Unregister last ad
        nativeAd.unregisterView();
        try {
            ActivityTemplate ctx = ((ActivityTemplate) context);
            ctx.onFbNativeAdLoaded();
